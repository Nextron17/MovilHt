...
import com.example.hortitechv1.view.fragments.HomeFragment;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private final ActivityResultLauncher<String> requestPermissionLauncher =
            registerForActivityResult(new ActivityResultContracts.RequestPermission(), isGranted -> {
                if (isGranted) {
                    ...
                    Toast.makeText(this, "No recibirás alertas importantes sin este permiso.", Toast.LENGTH_LONG).show();
                }
            });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        new android.os.Handler().postDelayed(() -> {
            if (itemId == R.id.nav_greenhouses) {
                startActivity(new Intent(HomeActivity.this, InvernaderoActivity.class));
            } else if (itemId == R.id.nav_crops) {
                startActivity(new Intent(HomeActivity.this, CultivosActivity.class));
            }else if (itemId == R.id.nav_log) {
                startActivity(new Intent(HomeActivity.this, BitacoraActivity.class));
